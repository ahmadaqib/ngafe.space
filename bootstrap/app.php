...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        health: '/up',
        then: function (): void {
            // Testing-only shortcut so Pest browser (Playwright) E2E can reach
            // authenticated flows without driving real Google OAuth. Never
            // registered outside the testing environment.
